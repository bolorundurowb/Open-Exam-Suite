...
namespace Simulator
{
    public partial class Score_Sheet : Form
    {
        ...
        public Score_Sheet(double elapsedTime, string examCode, int score, Dictionary<string, int> sectionQuestionNumbers, Dictionary<string, int> rightSectionQuestionNumbers)
        {
            InitializeComponent();
